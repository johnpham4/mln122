...
export const Part2_TheoryFoundation = (startId) => {
  ...
  const section1_1 = `
        ...
        **Lịch sử cách mạng công nghiệp:**
        ...
        [IMAGE:LaprapOto.png|Dây chuyền lắp ráp ô tô tại nhà máy của Công ty cổ phần Ô tô Trường Hải (Thaco) trong Khu kinh tế mở Chu Lai, huyện Núi Thành, tỉnh Quảng Nam.\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0 (Dây chuyền sản xuất ô tô hiện đại, nơi robot công nghiệp và con người cùng làm việc trong môi trường tự động hóa cao. Các cánh tay robot thực hiện thao tác hàn, lắp ráp chi tiết kim loại với độ chính xác gần như tuyệt đối, được điều khiển bởi các hệ thống trí tuệ nhân tạo (AI) và cảm biến kết nối mạng (IoT))]
